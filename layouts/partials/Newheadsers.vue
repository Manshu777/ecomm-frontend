            ...
            <div class="container-fluid flex pos-rel">
                <div class="left-area">
                    ...
                    <nuxt-link to="/" class="logo">
                      ...
                      <img class="logos_site" :src="imageURL({ 'image': site_setting.header_logo })" :alt="$t('footer.siteLogo')"
                            height="40" width="139">
                    </nuxt-link>
                </div>
                ...
                <div class="topBar-serach-bar" >
                    ...
                    <span class="menu-bar " @click="toggleSidebar"   :class="{ 'menu-none': !showMenuButton }" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.5" d="M2.75 12.25h10.5m-10.5-4h10.5m-10.5-4h10.5" />
                        </svg>
                ...
                <nuxt-link to="/cart" class="cart-btn flex pos-rel h-40x gap-5" :class="{ 'cart-none': !showCartButton }">
